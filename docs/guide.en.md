...
├── compass-archive.md    # where overturned decision rules go (history)
├── packets/
...
├── deltas.md             # the catch-all for learnings (reflected into documents after approval)
├── milestones.md         # records of milestone events
├── export-log.md         # history of handoffs (1 line = 1 handoff)
