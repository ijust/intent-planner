...
## OpenAI Build Week — CodexとGPT-5.6をどう使ったか

Build Weekでは、CodexとGPT-5.6を使い、CLI、エージェント用スキル、配布テンプレート、ドキュメント、テストにまたがる変更の実装と検証を進めました。同時に、変更の目的、守るべき制約、実装範囲をintent-planner自身で整理しました。対象としているエージェントと一緒に、対象としている開発方法でintent-plannerを作る、継続的な自己適用になっています。
