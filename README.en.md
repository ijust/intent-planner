...
5. As you approve the presented learnings item by item, the deltas are promoted into the Intent Tree / Compass / Packets. When a change to the decision criteria (Compass Decision Rules) is involved, a new ADR-style entry is added, and the old entry being replaced gets a superseded note.
