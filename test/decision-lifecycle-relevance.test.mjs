...
const STATUS_BASELINE_ROW_HASHES = {
  // 2026-07-27 の出口中立化に追随して更新（行数14・行番号・優先順位は不変）
  ja: "f1358aa5a98acb27215425b4fe5122bfa18d02bc5ced8425bae547f2920c08e8",
  en: "9460602950b1894862a97131bc1a7a1d750085dc86e8c86abfa9a75fd8abfa6f",
};
...
test("INV10 doc-sync: guide / theory が decision lifecycle を ja/en で案内する", () => {
  const documents = {
