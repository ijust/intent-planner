...
// ---- 群1: 4系統の SKILL.md + 5 rules + scaffold README が全て存在する (Req 1.1/1.2/1.3) ----
// 期待: 4 SKILL.md + 20 rule files + 2 scaffold README (ja/en)。1つでも欠ければ落ちる。

test("群1: 4系統 (ja/en × claude/codex) に SKILL.md + 5 rules が全て存在する (1.1/1.2)", () => {
  let skillCount = 0;
  let ruleCount = 0;
