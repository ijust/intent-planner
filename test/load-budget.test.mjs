...
// 2026-07-28: Graphiti 固有の工程指示を配布面から撤去したため、ルート規約6面の上限を
// 撤去後の実測に対する次の100Bへ引き下げた。呼び出し時層の予算は変更していない。
const BYTE_BUDGET = new Map([
  // 常時ロード層: ルート規約文書（本体）
  ["templates/ja/agents/claude/CLAUDE_intent.md", 14200],
  ["templates/ja/agents/codex/AGENTS.md", 14300],
  ["templates/ja/agents/gemini/GEMINI_intent.md", 14300],
  ["templates/en/agents/claude/CLAUDE_intent.md", 13700],
  ["templates/en/agents/codex/AGENTS.md", 13700],
  ["templates/en/agents/gemini/GEMINI_intent.md", 13700],
