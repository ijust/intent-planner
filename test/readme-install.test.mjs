...
const DOCS = [
  {
    ...
    guideLink: "https://github.com/ijust/intent-planner/blob/main/docs/guide.md#インストールのオプション",
  ...
  },
  {
    ...
    guideLink: "https://github.com/ijust/intent-planner/blob/main/docs/guide.en.md#installation-options",
