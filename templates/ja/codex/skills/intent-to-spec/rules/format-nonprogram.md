...
`intent-to-spec` skill が、source scope 解釈が読み取った三層の素材を、**非プログラム成果物向けの自然言語 Spec**（文書・業務プロセス・研究/意思決定など、外部 spec ツールを使わない経路の読める成果物）へ組み立てるための写像規則。SKILL.md は手順と報告形式のみを持ち、「どの素材をどの順で・どの見出しに配置するか」は本ルールを参照する。
