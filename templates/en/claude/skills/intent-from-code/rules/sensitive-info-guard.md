...
Do not send code, analysis results, or sensitive information to an external API or service. This prohibition applies equally to direct reading and to optional analysis selected by `read-scope.md`.
