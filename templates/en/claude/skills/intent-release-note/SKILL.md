...
argument-hint: <git range / format> (default range = latest tag..HEAD; `<from>..<to>` may be given; if no format is given, the default is used and the output states which format was generated)
---
