...
- Shell command usage is limited to getting the date/time, directory creation (mkdir) and moves under `.intent/packets/`, and the cleanup of the legacy packets.md during migration (the invariant of not changing application code stays).
