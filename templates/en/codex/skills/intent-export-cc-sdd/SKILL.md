...
- For files whose `## Source Packet` heading is absent or undecidable, ask the user in natural language where to move them and wait for their answer. Never move without confirmation.
