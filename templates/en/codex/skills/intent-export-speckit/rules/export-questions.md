...
The procedure for confirming unanswered `[by export]` Open Questions before running the export. Used at Step 1.7 of `/intent-export-speckit`. All dialogue is conducted as confirmation with the user (the means of confirmation follows the SKILL.md conventions).
