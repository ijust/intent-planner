...
Check unresolved `[by export]` Open Questions and important decisions at the start of the export. This procedure is used at Step 1.7 of `/intent-export-speckit`. Conduct all dialogue as confirmation with the user (follow the confirmation conventions in SKILL.md).
