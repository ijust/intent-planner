...
The Intent intelligence (mode definitions, algorithm rules, SDD tool bridges) and the planning deliverables live in `.intent/` and are agent-independent (`intent-tree.md`, `intent-compass.md`, `packets/`, mode, drafts for SDD tools, etc.). See `.intent/README.md` for the full list and details.
